  ...
  return `
    <header class="sticky top-0 z-20 border-b border-neutral-200 bg-white/95 backdrop-blur">
      <div class="mx-auto flex max-w-6xl items-center gap-3 px-4 py-3">
        <a href="#/" class="shrink-0 text-lg font-bold tracking-tight text-brand-600">
          Eshan<span class="text-neutral-900">Express</span>
        </a>

        <form id="search-form" role="search" class="ml-2 flex-1">
          ...
          <input id="q" name="q" type="search" placeholder="Search products…" autocomplete="off"
                 class="w-full rounded-lg border border-neutral-300 bg-neutral-50 px-3 py-2 text-sm
